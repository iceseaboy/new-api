# OPCLink Electron Desktop App

This directory contains the Electron wrapper for OPCLink, providing a native desktop application with system tray support for Windows, macOS, and Linux.
...
```bash
# If you have a pre-built binary (e.g., opclink-macos)
cp ../opclink-macos ../opclink
```
...
- Store database in `../data/opclink.db`
...
### Database Location
- **Development**: `../data/opclink.db` (project directory)
- **Production**:
  - macOS: `~/Library/Application Support/OPCLink/data/`
  - Windows: `%APPDATA%/OPCLink/data/`
  - Linux: `~/.config/OPCLink/data/`
