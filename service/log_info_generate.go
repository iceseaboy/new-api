...
func GenerateTextOtherInfo(ctx *gin.Context, relayInfo *relaycommon.RelayInfo, modelRatio, groupRatio, completionRatio float64,
	...
	if relayInfo.PriceData.GroupRatioInfo.HasUserModelRatio {
		other.SetPublic("user_model_ratio", relayInfo.PriceData.GroupRatioInfo.UserModelRatio)
	}
...
func GenerateMjOtherInfo(relayInfo *relaycommon.RelayInfo, priceData hosttypes.PriceData) *model.LogOther {
	...
	if priceData.GroupRatioInfo.HasUserModelRatio {
		other.SetPublic("user_model_ratio", priceData.GroupRatioInfo.UserModelRatio)
	}
