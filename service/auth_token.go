...
const (
	...
	authTokenIssuer       = "opclink"
	authTokenAudience     = "opclink-dashboard"
)
...
func authSigningKey(purpose string) []byte {
	...
	_, _ = mac.Write([]byte("opclink/auth/" + purpose + "/v1"))
	return mac.Sum(nil)
}
...
// ParseDashboardAccessToken distinguishes opclink dashboard JWTs from opaque
