...
import (
	...
	"github.com/QuantumNous/opclink/pkg/cachex"
...
const (
	...
	channelAffinityCacheNamespace           = "opclink:channel_affinity:v1"
	channelAffinityUsageCacheStatsNamespace = "opclink:channel_affinity_usage_cache_stats:v1"
)
