...
func GeminiHelper(c *gin.Context, info *relaycommon.RelayInfo) (opclinkError *types.OPCLinkError) {
...
func GeminiEmbeddingHandler(c *gin.Context, info *relaycommon.RelayInfo) (opclinkError *types.OPCLinkError) {
	info.InitChannelMeta(c)
