...
import (
	...
	"github.com/QuantumNous/opclink/relay/common"
...
func (a *Adaptor) DoResponse(c *gin.Context, resp *http.Response, info *common.RelayInfo) (usage any, err *types.OPCLinkError) {
	if info.IsStream {
