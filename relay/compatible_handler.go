...
func TextHelper(c *gin.Context, info *relaycommon.RelayInfo) (opclinkError *types.OPCLinkError) {
	...
	if info.RelayMode == relayconstant.RelayModeChatCompletions &&
		...
		usage, opclinkErr := chatCompletionsViaResponses(c, info, adaptor, request)
		if opclinkErr != nil {
			return opclinkErr
		}
	...
	usage, opclinkErr := adaptor.DoResponse(c, httpResp, info)
	if opclinkErr != nil {
		// reset status code 重置状态码
		service.ResetStatusCode(opclinkErr, statusCodeMappingStr)
		return opclinkErr
