...
<p align="center">
  <a href="https://raw.githubusercontent.com/Calcium-Ion/opclink/main/LICENSE">
    <img src="https://img.shields.io/github/license/Calcium-Ion/opclink?color=brightgreen" alt="licence">
  </a><!--
  --><a href="https://github.com/Calcium-Ion/opclink/releases/latest">
    <img src="https://img.shields.io/github/v/release/Calcium-Ion/opclink?color=brightgreen&include_prereleases" alt="version">
  </a><!--
  --><a href="https://hub.docker.com/r/CalciumIon/opclink">
    <img src="https://img.shields.io/badge/docker-dockerHub-blue" alt="docker">
  </a>
  <a href="https://atomgit.com/QuantumNous/opclink" target="_blank">
    <img alt="AtomGit G-Star" src="https://atomgit.com/QuantumNous/opclink/star/badge.svg"/>
  </a>
</p>

<p align="center">
  <a href="https://trendshift.io/repositories/20180" target="_blank">
    <img src="https://trendshift.io/api/badge/repositories/20180" alt="QuantumNous%2Fopclink | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/>
  </a>
  <br>
  <a href="https://hellogithub.com/repository/QuantumNous/opclink" target="_blank">
    <img src="https://api.hellogithub.com/v1/widgets/recommend.svg?rid=539ac4217e69431684ad4a0bab768811&claim_uid=tbFPfKIDHpc4TzR" alt="Featured｜HelloGitHub" style="width: 250px; height: 54px;" width="250" height="54" />
  </a><!--
  -->
  <a href="https://atomgit.com/QuantumNous/opclink" target="_blank">
    <img alt="AtomGit G-Star" src="https://atomgit.com/QuantumNous/opclink/star/new_badge.svg" width="250" height="55" />
  </a>
</p>
...
<p align="center">
  ...
  --><a href="https://www.compshare.cn/?ytag=GPU_yy_gh_opclink" target="_blank">
...
<p align="center">
  <a href="https://www.jetbrains.com/?from=opclink" target="_blank">
    <img src="https://resources.jetbrains.com/storage/products/company/brand/logos/jb_beam.png" alt="JetBrains Logo" width="120" />
  </a>
</p>

<p align="center">
  <strong>Merci à <a href="https://www.jetbrains.com/?from=opclink">JetBrains</a> pour avoir fourni une licence de développement open-source gratuite pour ce projet</strong>
</p>
...
```bash
# Cloner le projet
git clone https://github.com/QuantumNous/opclink.git
cd opclink
...
docker pull calciumion/opclink:latest

# Utilisation de SQLite (par défaut)
docker run --name opclink -d --restart always \
  -p 3000:3000 \
  -e TZ=Asia/Shanghai \
  -v ./data:/data \
  calciumion/opclink:latest
...
📖 Pour plus de méthodes de déploiement, veuillez vous référer à [Guide de déploiement](https://docs.opclink.pro/en/docs/installation)
...
### 📖 [Documentation officielle](https://docs.opclink.pro/en/docs) | [![Demander à DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/QuantumNous/opclink)
...
| Catégorie | Lien |
|------|------|
| 🚀 Guide de déploiement | [Documentation d'installation](https://docs.opclink.pro/en/docs/installation) |
| ⚙️ Configuration de l'environnement | [Variables d'environnement](https://docs.opclink.pro/en/docs/installation/config-maintenance/environment-variables) |
| 📡 Documentation de l'API | [Documentation de l'API](https://docs.opclink.pro/en/docs/api) |
| ❓ FAQ | [FAQ](https://docs.opclink.pro/en/docs/support/faq) |
| 💬 Interaction avec la communauté | [Canaux de communication](https://docs.opclink.pro/en/docs/support/community-interaction) |

---

## ✨ Fonctionnalités clés

> Pour les fonctionnalités détaillées, veuillez vous référer à [Présentation des fonctionnalités](https://docs.opclink.pro/en/docs/guide/wiki/basic-concepts/features-introduction) |
...
- 🔍 Requête de quota d'utilisation de clé (avec [opclink-key-tool](https://github.com/Calcium-Ion/opclink-key-tool))

### 🚀 Fonctionnalités avancées

**Prise en charge des formats d'API:**
- ⚡ [OpenAI Responses](https://docs.opclink.pro/en/docs/api/ai-model/chat/openai/create-response)
- ⚡ [OpenAI Realtime API](https://docs.opclink.pro/en/docs/api/ai-model/realtime/create-realtime-session) (y compris Azure)
- ⚡ [Claude Messages](https://docs.opclink.pro/en/docs/api/ai-model/chat/create-message)
- ⚡ [Google Gemini](https://doc.opclink.pro/en/api/google-gemini-chat)
- 🔄 [Modèles Rerank](https://docs.opclink.pro/en/docs/api/ai-model/rerank/create-rerank) (Cohere, Jina)
...
> Pour les détails, veuillez vous référer à [Documentation de l'API - Interface de passerelle](https://docs.opclink.pro/en/docs/api)

| Type de modèle | Description | Documentation |
|---------|------|------|
| 🤖 OpenAI-Compatible | Modèles compatibles OpenAI | [Documentation](https://docs.opclink.pro/en/docs/api/ai-model/chat/openai/createchatcompletion) |
| 🤖 OpenAI Responses | Format OpenAI Responses | [Documentation](https://docs.opclink.pro/en/docs/api/ai-model/chat/openai/createresponse) |
| 🎨 Midjourney-Proxy | [Midjourney-Proxy(Plus)](https://github.com/novicezk/midjourney-proxy) | [Documentation](https://doc.opclink.pro/api/midjourney-proxy-image) |
| 🎵 Suno-API | [Suno API](https://github.com/Suno-API/Suno-API) | [Documentation](https://doc.opclink.pro/api/suno-music) |
| 🔄 Rerank | Cohere, Jina | [Documentation](https://docs.opclink.pro/en/docs/api/ai-model/rerank/creatererank) |
| 💬 Claude | Format Messages | [Documentation](https://docs.opclink.pro/en/docs/api/ai-model/chat/createmessage) |
| 🌐 Gemini | Format Google Gemini | [Documentation](https://docs.opclink.pro/en/docs/api/ai-model/chat/gemini/geminirelayv1beta) |
| 🔧 Dify | Mode ChatFlow | - |
...
- [Interface de discussion (Chat Completions)](https://docs.opclink.pro/en/docs/api/ai-model/chat/openai/createchatcompletion)
- [Interface de réponse (Responses)](https://docs.opclink.pro/en/docs/api/ai-model/chat/openai/createresponse)
- [Interface d'image (Image)](https://docs.opclink.pro/en/docs/api/ai-model/images/openai/post-v1-images-generations)
- [Interface audio (Audio)](https://docs.opclink.pro/en/docs/api/ai-model/audio/openai/create-transcription)
- [Interface vidéo (Video)](https://docs.opclink.pro/en/docs/api/ai-model/audio/openai/createspeech)
- [Interface d'incorporation (Embeddings)](https://docs.opclink.pro/en/docs/api/ai-model/embeddings/createembedding)
- [Interface de rerank (Rerank)](https://docs.opclink.pro/en/docs/api/ai-model/rerank/creatererank)
- [Conversation en temps réel (Realtime)](https://docs.opclink.pro/en/docs/api/ai-model/realtime/createrealtimesession)
- [Discussion Claude](https://docs.opclink.pro/en/docs/api/ai-model/chat/createmessage)
- [Discussion Google Gemini](https://docs.opclink.pro/en/docs/api/ai-model/chat/gemini/geminirelayv1beta)
...
> [!TIP]
> **Dernière image Docker:** `calciumion/opclink:latest`
...
| `PYROSCOPE_APP_NAME` | Nom de l'application Pyroscope | `opclink` |
...
| `HOSTNAME` | Nom d'hôte tagué pour Pyroscope | `opclink` |

📖 **Configuration complète:** [Documentation des variables d'environnement](https://docs.opclink.pro/en/docs/installation/config-maintenance/environment-variables)
...
2. Recherchez **OPCLink** dans le magasin d'applications
...
| Projet | Description |
|------|------|
| [opclink-key-tool](https://github.com/Calcium-Ion/opclink-key-tool) | Outil de recherche de quota d'utilisation avec une clé |
| [opclink-horizon](https://github.com/Calcium-Ion/opclink-horizon) | Version optimisée haute performance de OPCLink |
...
| 📘 FAQ | [FAQ](https://docs.opclink.pro/en/docs/support/faq) |
| 💬 Interaction avec la communauté | [Canaux de communication](https://docs.opclink.pro/en/docs/support/community-interaction) |
| 🐛 Commentaires sur les problèmes | [Commentaires sur les problèmes](https://docs.opclink.pro/en/docs/support/feedback-issues) |
| 📚 Documentation complète | [Documentation officielle](https://docs.opclink.pro/en/docs) |
...
[![Graphique de l'historique des étoiles](https://api.star-history.com/svg?repos=Calcium-Ion/opclink&type=Date)](https://star-history.com/#Calcium-Ion/opclink&Date)
...
### 💖 Merci d'utiliser OPCLink

Si ce projet vous est utile, bienvenue à nous donner une ⭐️ Étoile！

**[Documentation officielle](https://docs.opclink.pro/en/docs)** • **[Commentaires sur les problèmes](https://github.com/Calcium-Ion/opclink/issues)** • **[Dernière version](https://github.com/Calcium-Ion/opclink/releases)**
