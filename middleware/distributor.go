...
func SetupContextForSelectedChannel(c *gin.Context, channel *model.Channel, modelName string) *types.OPCLinkError {
	...
	key, index, opclinkError := channel.GetNextEnabledKey()
	if opclinkError != nil {
		return opclinkError
	}
