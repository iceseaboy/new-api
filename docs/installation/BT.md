...
本文档提供使用宝塔面板 Docker 功能部署 OPCLink 的图文教程。

> 📖 官方文档：[宝塔面板部署](https://docs.opclink.pro/zh/docs/installation/deployment-methods/bt-docker-installation)
...
1. 在宝塔面板中创建网站目录，如 `/www/wwwroot/opclink`
...
services:
  opclink:
    image: calciumion/opclink:latest
    container_name: opclink
    restart: always
    ports:
      - "3000:3000"
    volumes:
...
- [官方文档](https://docs.opclink.pro/zh/docs/installation)
- [环境变量配置](https://docs.opclink.pro/zh/docs/installation/config-maintenance/environment-variables)
- [常见问题](https://docs.opclink.pro/zh/docs/support/faq)
- [GitHub 仓库](https://github.com/QuantumNous/opclink)
